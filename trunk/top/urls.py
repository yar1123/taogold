...
urlpatterns = patterns('',
    ...
    url(r'^top/new-template.html', newtemplate),
    url(r'^top/saveedit.html', saveEditTemplate),
    url(r'^top/edit.html', editTemplate),
    url(r'^top/onsales.html', onsaleGoods),
